...
Estimate the following model from the previous practice exercises with and without region variables. Name your models $crime.lm1$ (unrestricted model with regions) $crime.lmr$ (restricted model without regions): 

  - Calculate the test statistic for the presence of risk-adjusted (controlling for other factors) regional differences in crime rates *by hand* using the restricted and unrestricted $R^2$. 
