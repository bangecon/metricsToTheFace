...
$$\begin{align}Final &= \beta_0 + \beta_1Attendance + \beta_2PriorGPA + \beta_3ACT \\ &+ \beta_4PriorGPA^2 + \beta_5ACT^2 \end{align}$$
where: 
...
$$\begin{align}Final &= \beta_0 + \beta_1Attendance + \beta_2PriorGPA + \beta_3ACT \\ &+ \beta_4PriorGPA^2 + \beta_5ACT^2 + \beta_6PriorGPA \cdot Attendance + u \end{align}$$
