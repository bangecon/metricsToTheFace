...
Let's simulate the bias of dividing by $n$ for the sample variance for different sample sizes. Run the following code to see the simulation of the bias for different sample sizes. 
...
2. Use plot(density()) lot the smoothed estimated densities of xBar for n = 2, 10, 30, and 100, set the x-axis limits to (-1, 3) and the y-axis limits to (0, 4).
